...
save(scaled_space, file="./data/InputData/scaled_beta_space_MOW.RData")
...
save(scaled_time, file="./data/InputData/scaled_beta_time_MOW.RData")

########################
###LINEAR MODELS
#######################
load("./data/InputData/scaled_beta_space_MOW.RData")
load("./data/InputData/scaled_beta_time_MOW.RData")
...
save(EV_space, file="./data/OutputData/EV_space_MOW.RData")
...
save(EV_time, file="./data/OutputData/EV_time_MOW_beta.RData")

#set working directory to folder "4. Plotting results"
save(EV_time, file="./data/InputData/EV_time_MOW_beta.RData")
